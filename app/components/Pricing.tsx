    ...
    <section id="pricing" className="py-32 md:py-40">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="mb-12 text-center">
          <h2 className="mb-4 font-mono text-2xl text-balance md:text-4xl">
            Pricing <em>&</em> Engagement
          </h2>
          <p className="text-muted-foreground font-mono text-sm text-balance leading-relaxed">
        ...
        <div className="grid gap-4 md:grid-cols-6 md:grid-rows-3">
          ...
          <RetainerPricingCard className="md:col-span-3 md:row-span-2" />
