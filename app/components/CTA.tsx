      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <button
            ...
            className="bg-foreground text-background hover:bg-primary focus:ring-primary inline-flex items-center justify-center rounded-xl px-6 py-3 text-base font-semibold transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none"
          >
            Schedule a Call
          </button>
          <button
            onClick={handleContactClick}
            className="border-foreground text-foreground hover:bg-foreground hover:text-background focus:ring-primary inline-flex items-center justify-center rounded-xl border px-6 py-3 text-base font-semibold transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none"
          >
            Send Message
          </button>
        </div>
